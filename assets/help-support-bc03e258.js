import{k as o,r as e,L as r}from"./index-7eacecaa.js";import{i as s,S as l}from"./i18n-117ab3ba.js";import{M as i}from"./index.modern-a3380b21.js";const a={en:`
# Help and Support
## Immediate help
...
`},c=()=>{const[t,n]=e.useState(localStorage.getItem("lang")||r[0].code);return e.useEffect(()=>{localStorage.setItem("lang",t),document.documentElement.setAttribute("lang",t),s.changeLanguage(t)},[t]),e.createElement(e.Fragment,null,e.createElement(l,{setLang:n}),e.createElement(i,null,a[t]||a.en))},u=o(document.getElementById("root"));u.render(e.createElement(c,null));
//# sourceMappingURL=help-support-bc03e258.js.map
